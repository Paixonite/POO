...
public abstract class Conta implements ITaxas, Serializable {
    ...
    public Conta(int numAgencia, int numero, Cliente dono, double saldo, double limite) {
    ...
    public void serializar() throws IOException{
        FileOutputStream fileOut = new FileOutputStream(this.getNumAgencia() + "-" + this.getNumero() + ".ser");
